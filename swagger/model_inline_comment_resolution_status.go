...
const (
	OPEN InlineCommentResolutionStatus = "open"
	REOPENED InlineCommentResolutionStatus = "reopened"
	RESOLVED InlineCommentResolutionStatus = "resolved"
	DANGLING InlineCommentResolutionStatus = "dangling"
)
