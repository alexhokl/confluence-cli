...
// checks if the CreateDatabase200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDatabase200Response{}

// CreateDatabase200Response struct for CreateDatabase200Response
type CreateDatabase200Response struct {
	// ID of the database.
...
func NewCreateDatabase200Response() *CreateDatabase200Response {
	this := CreateDatabase200Response{}
	return &this
}
...
func (o *CreateDatabase200Response) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o CreateDatabase200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateDatabase200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDatabase200Response struct {
	value *CreateDatabase200Response
	isSet bool
}

func (v NullableCreateDatabase200Response) Get() *CreateDatabase200Response {
	return v.value
}

func (v *NullableCreateDatabase200Response) Set(val *CreateDatabase200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDatabase200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDatabase200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDatabase200Response(val *CreateDatabase200Response) *NullableCreateDatabase200Response {
	return &NullableCreateDatabase200Response{value: val, isSet: true}
}

func (v NullableCreateDatabase200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDatabase200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
