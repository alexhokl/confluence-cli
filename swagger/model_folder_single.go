...
// checks if the FolderSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolderSingle{}

// FolderSingle struct for FolderSingle
...
func (o *FolderSingle) SetPositionNil() {
	o.Position.Set(nil)
}
...
// SetLinks gets a reference to the given FolderLinks and assigns it to the Links field.
func (o *FolderSingle) SetLinks(v FolderLinks) {
	o.Links = &v
}

func (o FolderSingle) MarshalJSON() ([]byte, error) {
...
func (o FolderSingle) ToMap() (map[string]interface{}, error) {
...
type NullableFolderSingle struct {
	value *FolderSingle
	isSet bool
}

func (v NullableFolderSingle) Get() *FolderSingle {
	return v.value
}

func (v *NullableFolderSingle) Set(val *FolderSingle) {
	v.value = val
	v.isSet = true
}

func (v NullableFolderSingle) IsSet() bool {
	return v.isSet
}

func (v *NullableFolderSingle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolderSingle(val *FolderSingle) *NullableFolderSingle {
	return &NullableFolderSingle{value: val, isSet: true}
}

func (v NullableFolderSingle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolderSingle) UnmarshalJSON(src []byte) error {
	v.isSet = true
