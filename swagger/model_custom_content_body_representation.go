...
const (
	CUSTOM_CONTENT_BODY_REPRESENTATION_RAW              CustomContentBodyRepresentation = "raw"
	CUSTOM_CONTENT_BODY_REPRESENTATION_STORAGE          CustomContentBodyRepresentation = "storage"
	CUSTOM_CONTENT_BODY_REPRESENTATION_ATLAS_DOC_FORMAT CustomContentBodyRepresentation = "atlas_doc_format"
)
