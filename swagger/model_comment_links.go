...
// checks if the CommentLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommentLinks{}
...
func (o *CommentLinks) GetWebui() string {
...
func (o *CommentLinks) GetWebuiOk() (*string, bool) {
	if o == nil || IsNil(o.Webui) {
		return nil, false
	}
	return o.Webui, true
...
func (o *CommentLinks) HasWebui() bool {
	if o != nil && !IsNil(o.Webui) {
		return true
	}
...
func (o *CommentLinks) SetWebui(v string) {
	o.Webui = &v
}
...
func (o CommentLinks) ToMap() (map[string]interface{}, error) {
