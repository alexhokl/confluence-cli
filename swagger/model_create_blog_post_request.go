...
type _CreateBlogPostRequest CreateBlogPostRequest
...
func (o *CreateBlogPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateBlogPostRequest := _CreateBlogPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateBlogPostRequest)

	if err != nil {
		return err
	}

	*o = CreateBlogPostRequest(varCreateBlogPostRequest)
