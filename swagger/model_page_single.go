...
// checks if the PageSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSingle{}

// PageSingle struct for PageSingle
...
func (o *PageSingle) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *PageSingle) SetOwnerIdNil() {
	o.OwnerId.Set(nil)
}
...
func (o *PageSingle) SetLastOwnerIdNil() {
...
func (o PageSingle) MarshalJSON() ([]byte, error) {
...
func (o PageSingle) ToMap() (map[string]interface{}, error) {
...
type NullablePageSingle struct {
	value *PageSingle
	isSet bool
}

func (v NullablePageSingle) Get() *PageSingle {
	return v.value
}

func (v *NullablePageSingle) Set(val *PageSingle) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSingle) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSingle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSingle(val *PageSingle) *NullablePageSingle {
	return &NullablePageSingle{value: val, isSet: true}
}

func (v NullablePageSingle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSingle) UnmarshalJSON(src []byte) error {
	v.isSet = true
