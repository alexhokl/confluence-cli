...
const (
	ATTACHMENT_SORT_ORDER_CREATED_DATE       AttachmentSortOrder = "created-date"
	ATTACHMENT_SORT_ORDER_CREATED_DATE_DESC  AttachmentSortOrder = "-created-date"
	ATTACHMENT_SORT_ORDER_MODIFIED_DATE      AttachmentSortOrder = "modified-date"
	ATTACHMENT_SORT_ORDER_MODIFIED_DATE_DESC AttachmentSortOrder = "-modified-date"
)
