...
func (a *TaskAPIService) GetTasksExecute(r ApiGetTasksRequest) (*MultiEntityResultTask, *http.Response, error) {
	...
	if r.includeBlankTasks != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include-blank-tasks", r.includeBlankTasks, "form", "")
	}
	if r.status != nil {
	...
	if r.taskId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "task-id", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "task-id", t, "form", "multi")
		}
	}
	if r.spaceId != nil {
		t := *r.spaceId
	...
	if r.pageId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "page-id", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "page-id", t, "form", "multi")
		}
	}
	if r.blogpostId != nil {
		t := *r.blogpostId
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "blogpost-id", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "blogpost-id", t, "form", "multi")
		}
	}
	if r.createdBy != nil {
		t := *r.createdBy
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "created-by", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "created-by", t, "form", "multi")
		}
	}
	if r.assignedTo != nil {
		t := *r.assignedTo
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "assigned-to", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "assigned-to", t, "form", "multi")
		}
	}
	if r.completedBy != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "completed-by", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "completed-by", t, "form", "multi")
		}
	}
	if r.createdAtFrom != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "created-at-from", r.createdAtFrom, "form", "")
	}
	if r.createdAtTo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "created-at-to", r.createdAtTo, "form", "")
	}
	if r.dueAtFrom != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "due-at-from", r.dueAtFrom, "form", "")
	}
	if r.dueAtTo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "due-at-to", r.dueAtTo, "form", "")
	}
	if r.completedAtFrom != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "completed-at-from", r.completedAtFrom, "form", "")
	}
	if r.completedAtTo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "completed-at-to", r.completedAtTo, "form", "")
	}
	if r.cursor != nil {
...
// The content format types to be returned in the &#x60;body&#x60; field of the response. If available, the representation will be available under a response field of the same name under the &#x60;body&#x60; field.
func (r ApiUpdateTaskRequest) BodyFormat(bodyFormat PrimaryBodyRepresentation) ApiUpdateTaskRequest {
	r.bodyFormat = &bodyFormat
	return r
}
