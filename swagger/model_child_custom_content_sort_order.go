...
const (
	CHILD_CUSTOM_CONTENT_SORT_ORDER_CREATED_DATE       ChildCustomContentSortOrder = "created-date"
	CHILD_CUSTOM_CONTENT_SORT_ORDER_CREATED_DATE_DESC  ChildCustomContentSortOrder = "-created-date"
	CHILD_CUSTOM_CONTENT_SORT_ORDER_ID                 ChildCustomContentSortOrder = "id"
	CHILD_CUSTOM_CONTENT_SORT_ORDER_ID_DESC            ChildCustomContentSortOrder = "-id"
	CHILD_CUSTOM_CONTENT_SORT_ORDER_MODIFIED_DATE      ChildCustomContentSortOrder = "modified-date"
	CHILD_CUSTOM_CONTENT_SORT_ORDER_MODIFIED_DATE_DESC ChildCustomContentSortOrder = "-modified-date"
)
