...
const (
	CHILD_PAGE_SORT_ORDER_CREATED_DATE        ChildPageSortOrder = "created-date"
	CHILD_PAGE_SORT_ORDER_CREATED_DATE_DESC   ChildPageSortOrder = "-created-date"
	CHILD_PAGE_SORT_ORDER_ID                  ChildPageSortOrder = "id"
	CHILD_PAGE_SORT_ORDER_ID_DESC             ChildPageSortOrder = "-id"
	CHILD_PAGE_SORT_ORDER_CHILD_POSITION      ChildPageSortOrder = "child-position"
	CHILD_PAGE_SORT_ORDER_CHILD_POSITION_DESC ChildPageSortOrder = "-child-position"
	CHILD_PAGE_SORT_ORDER_MODIFIED_DATE       ChildPageSortOrder = "modified-date"
	CHILD_PAGE_SORT_ORDER_MODIFIED_DATE_DESC  ChildPageSortOrder = "-modified-date"
)
