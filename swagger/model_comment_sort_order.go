...
const (
	COMMENT_SORT_ORDER_CREATED_DATE       CommentSortOrder = "created-date"
	COMMENT_SORT_ORDER_CREATED_DATE_DESC  CommentSortOrder = "-created-date"
	COMMENT_SORT_ORDER_MODIFIED_DATE      CommentSortOrder = "modified-date"
	COMMENT_SORT_ORDER_MODIFIED_DATE_DESC CommentSortOrder = "-modified-date"
)
