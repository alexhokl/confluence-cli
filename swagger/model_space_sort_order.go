...
const (
	SPACE_SORT_ORDER_ID        SpaceSortOrder = "id"
	SPACE_SORT_ORDER_ID_DESC   SpaceSortOrder = "-id"
	SPACE_SORT_ORDER_KEY       SpaceSortOrder = "key"
	SPACE_SORT_ORDER_KEY_DESC  SpaceSortOrder = "-key"
	SPACE_SORT_ORDER_NAME      SpaceSortOrder = "name"
	SPACE_SORT_ORDER_NAME_DESC SpaceSortOrder = "-name"
)
