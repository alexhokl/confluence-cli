...
type _ConvertContentIdsToContentTypesRequest ConvertContentIdsToContentTypesRequest
...
func (o *ConvertContentIdsToContentTypesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varConvertContentIdsToContentTypesRequest := _ConvertContentIdsToContentTypesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConvertContentIdsToContentTypesRequest)

	if err != nil {
		return err
	}

	*o = ConvertContentIdsToContentTypesRequest(varConvertContentIdsToContentTypesRequest)
