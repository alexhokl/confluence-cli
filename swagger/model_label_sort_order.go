...
const (
	LABEL_SORT_ORDER_CREATED_DATE      LabelSortOrder = "created-date"
	LABEL_SORT_ORDER_CREATED_DATE_DESC LabelSortOrder = "-created-date"
	LABEL_SORT_ORDER_ID                LabelSortOrder = "id"
	LABEL_SORT_ORDER_ID_DESC           LabelSortOrder = "-id"
	LABEL_SORT_ORDER_NAME              LabelSortOrder = "name"
	LABEL_SORT_ORDER_NAME_DESC         LabelSortOrder = "-name"
)
