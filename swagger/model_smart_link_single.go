...
// checks if the SmartLinkSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmartLinkSingle{}

// SmartLinkSingle struct for SmartLinkSingle
...
func (o *SmartLinkSingle) SetPositionNil() {
	o.Position.Set(nil)
}
...
// SetLinks gets a reference to the given SmartLinkLinks and assigns it to the Links field.
func (o *SmartLinkSingle) SetLinks(v SmartLinkLinks) {
	o.Links = &v
}

func (o SmartLinkSingle) MarshalJSON() ([]byte, error) {
...
func (o SmartLinkSingle) ToMap() (map[string]interface{}, error) {
...
type NullableSmartLinkSingle struct {
	value *SmartLinkSingle
	isSet bool
}

func (v NullableSmartLinkSingle) Get() *SmartLinkSingle {
	return v.value
}

func (v *NullableSmartLinkSingle) Set(val *SmartLinkSingle) {
	v.value = val
	v.isSet = true
}

func (v NullableSmartLinkSingle) IsSet() bool {
	return v.isSet
}

func (v *NullableSmartLinkSingle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmartLinkSingle(val *SmartLinkSingle) *NullableSmartLinkSingle {
	return &NullableSmartLinkSingle{value: val, isSet: true}
}

func (v NullableSmartLinkSingle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmartLinkSingle) UnmarshalJSON(src []byte) error {
	v.isSet = true
