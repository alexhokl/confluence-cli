...
const (
	BLOG_POST_SORT_ORDER_ID                 BlogPostSortOrder = "id"
	BLOG_POST_SORT_ORDER_ID_DESC            BlogPostSortOrder = "-id"
	BLOG_POST_SORT_ORDER_CREATED_DATE       BlogPostSortOrder = "created-date"
	BLOG_POST_SORT_ORDER_CREATED_DATE_DESC  BlogPostSortOrder = "-created-date"
	BLOG_POST_SORT_ORDER_MODIFIED_DATE      BlogPostSortOrder = "modified-date"
	BLOG_POST_SORT_ORDER_MODIFIED_DATE_DESC BlogPostSortOrder = "-modified-date"
)
