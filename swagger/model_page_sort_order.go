...
const (
	PAGE_SORT_ORDER_ID                 PageSortOrder = "id"
	PAGE_SORT_ORDER_ID_DESC            PageSortOrder = "-id"
	PAGE_SORT_ORDER_CREATED_DATE       PageSortOrder = "created-date"
	PAGE_SORT_ORDER_CREATED_DATE_DESC  PageSortOrder = "-created-date"
	PAGE_SORT_ORDER_MODIFIED_DATE      PageSortOrder = "modified-date"
	PAGE_SORT_ORDER_MODIFIED_DATE_DESC PageSortOrder = "-modified-date"
	PAGE_SORT_ORDER_TITLE              PageSortOrder = "title"
	PAGE_SORT_ORDER_TITLE_DESC         PageSortOrder = "-title"
)
