...
type _CreateCustomContentRequest CreateCustomContentRequest
...
func (o *CreateCustomContentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCustomContentRequest := _CreateCustomContentRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCustomContentRequest)

	if err != nil {
		return err
	}

	*o = CreateCustomContentRequest(varCreateCustomContentRequest)
