...
type UpdateCustomContentRequest struct {
	...
	Version UpdateCustomContentRequestVersion `json:"version"`
}

type _UpdateCustomContentRequest UpdateCustomContentRequest
...
func (o *UpdateCustomContentRequest) GetVersion() UpdateCustomContentRequestVersion {
	if o == nil {
		var ret UpdateCustomContentRequestVersion
		return ret
	}
...
func (o *UpdateCustomContentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCustomContentRequest := _UpdateCustomContentRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateCustomContentRequest)

	if err != nil {
		return err
	}

	*o = UpdateCustomContentRequest(varUpdateCustomContentRequest)
