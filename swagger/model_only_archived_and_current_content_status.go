...
const (
	ONLY_ARCHIVED_AND_CURRENT_CONTENT_STATUS_CURRENT  OnlyArchivedAndCurrentContentStatus = "current"
	ONLY_ARCHIVED_AND_CURRENT_CONTENT_STATUS_ARCHIVED OnlyArchivedAndCurrentContentStatus = "archived"
)
