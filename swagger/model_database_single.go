...
// checks if the DatabaseSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseSingle{}

// DatabaseSingle struct for DatabaseSingle
...
func (o *DatabaseSingle) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o DatabaseSingle) MarshalJSON() ([]byte, error) {
...
func (o DatabaseSingle) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseSingle struct {
	value *DatabaseSingle
	isSet bool
}

func (v NullableDatabaseSingle) Get() *DatabaseSingle {
	return v.value
}

func (v *NullableDatabaseSingle) Set(val *DatabaseSingle) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseSingle) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseSingle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseSingle(val *DatabaseSingle) *NullableDatabaseSingle {
	return &NullableDatabaseSingle{value: val, isSet: true}
}

func (v NullableDatabaseSingle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseSingle) UnmarshalJSON(src []byte) error {
	v.isSet = true
