...
const (
	SPACE_DESCRIPTION_BODY_REPRESENTATION_PLAIN SpaceDescriptionBodyRepresentation = "plain"
	SPACE_DESCRIPTION_BODY_REPRESENTATION_VIEW  SpaceDescriptionBodyRepresentation = "view"
)
