...
type _CheckAccessByEmailRequest CheckAccessByEmailRequest
...
func (o *CheckAccessByEmailRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckAccessByEmailRequest := _CheckAccessByEmailRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckAccessByEmailRequest)

	if err != nil {
		return err
	}

	*o = CheckAccessByEmailRequest(varCheckAccessByEmailRequest)
